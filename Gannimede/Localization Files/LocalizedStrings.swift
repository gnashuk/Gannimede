...
struct LocalizedStrings {
    struct AlertTitles {
        ...
        static let ConfirmCreation = NSLocalizedString("Confirm Creation", comment: "Confirm channel creation.")
    ...
    struct AlertMessages {
        ...
        static let ConfirmCreation = NSLocalizedString("Do you want to create the channel %@?", comment: "Do you want to create the channel?")
